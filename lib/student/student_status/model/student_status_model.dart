...
class StudentStatusModel {
  ...
  StudentStatusModel({required this.id, required this.event_id, required this.user_id, required this.title, required this.image, required this.club, required this.location, required this.date, required this.status});
